try:
    # First choice: direct pdfBridge call from Pyodide (no postMessage / Worker refs needed)
    from check_logic import pdf_wrapper_direct as fitz
except ImportError:
    try:
        # Try to use preprocessed wrapper (for Stlite/browser environment with preprocessed data)
